...
// )
func nothing() {
	pleasecompilerstfu := "a"
	fmt.Println(pleasecompilerstfu)
}

// func loadDataset(filePath string, skipHeader bool, nameRow int, coordinateStart int, coordinatesEnd int, delimiter rune) []Vertex {
// 	dataset := []Vertex{}
